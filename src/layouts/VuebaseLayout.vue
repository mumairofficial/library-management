    ...
    <v-app>
      <v-navigation-drawer
          ...
          <v-list class="pa-0" :class="{'list-border-bottom' : miniVariant}">
            <v-list-tile>
              <v-list-tile-action v-if="!miniVariant">
                <v-icon large color="orange">store</v-icon>
              </v-list-tile-action>
        ...
        <v-list subheader :class="{'list-border-bottom' : miniVariant}">
          ...
          <template v-for="item in analyticsItems">
            <v-tooltip right :disabled="!miniVariant" :key="item.link">
              <v-list-tile
                :key="item.icon"
                :to="item.link"
                exact
      ...
      <v-toolbar
        ...
        <v-toolbar-side-icon
          ...
          <v-menu :close-on-content-click="false"  bottom left class="m-r-md">
            <v-btn @click="" icon
            ...
            <v-list>
              <v-list-tile avatar>
                ...
                <v-list-tile-content>
                  <v-list-tile-title>Muhammad Umair</v-list-tile-title>
                  <v-list-tile-sub-title>muhammadumair@outlook.com</v-list-tile-sub-title>
                </v-list-tile-content>
              </v-list-tile>
